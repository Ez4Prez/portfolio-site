    ...
    return (
        <div className="home-container" >
            ...
            <div className="home-bio-wrapper">
                <h4 className="home-bio">Welcome to my porfolio and project hub. I am a full-stack web developer with a drive for creativity and ingenuity. Feel free to check out my work and reach out to make friends.</h4>
            </div>
